...
<div class="verse-display-box">
    ...
    {#if recallMethod === 'voice'}
        ...
        <div class="mic-container">
            <button class="mic-circle-btn giant" class:active={recordState === 'recording'} onclick={(e) => { e.preventDefault(); e.stopPropagation(); startSimulatedRecording(); }} disabled={isChecked} title={i18n.t('lesson.mic_title_voice')}>
