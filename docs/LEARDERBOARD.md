...
- Jumlah anggota per halaqah: **minimal 2, maksimal 20 orang**
...
| Leaderboard komunitas | ❌ Tidak masuk, kan kagak masuk | ✅ Masuk |
...
| Event  | Sesuai jangka event |

**Privasi leaderboard**
Yang tampil di leaderboard adalah USERNAME dan total perolehan XP

**Leaderboard per komunitas — per halaqah**
Di leaderboard komunitas mode "per halaqah", yang dibandingkan adalah **halaqah sebagai unit** — bukan individu. XP dihitung dari kegiatan yang ada di dalam halaqah tersebut
